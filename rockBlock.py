...
# -*- coding: utf-8 -*-
#
#    Improved version by Sam Neurohack
#    Original code with added lines to support other modem functions :
#
#    - getSerialIdentifier() - returns antenna serial number
#    - model() - returns Antenna model
#    - momsn() - returns next outbound message number (momsn), 
#    - signal() - returns signal quality (0-5), Network time and GPS position.
#    - geo() - returns GPS position
#
# 
